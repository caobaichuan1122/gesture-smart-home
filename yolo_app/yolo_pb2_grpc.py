...
class YOLOServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Detect = channel.unary_unary(
                ...
                request_serializer=yolo__pb2.DetectionRequest.SerializeToString,
                response_deserializer=yolo__pb2.DetectionResponse.FromString,
...
def add_YOLOServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Detect': grpc.unary_unary_rpc_method_handler(
                    servicer.Detect,
                    request_deserializer=yolo__pb2.DetectionRequest.FromString,
                    response_serializer=yolo__pb2.DetectionResponse.SerializeToString,
            ),
    }
...
class YOLOService(object):
    ...
    def Detect(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/yolo.YOLOService/Detect',
            yolo__pb2.DetectionRequest.SerializeToString,
            yolo__pb2.DetectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
